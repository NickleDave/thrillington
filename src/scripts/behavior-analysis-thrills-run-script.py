...
def main():
    ...
    behavior(run_results, suffix='_epoch_test', suptitle=suptitle, save_as=save_as)

    test_results = '/home/bart/Documents/data/RAM_output/RAM_results_190420_231619/test_results_190422_212943/replicate_1'
    suptitle = "learning rate = 0.01, standard devation = 0.2, test acc = 73.8%"
    save_as = "lr0.001_std1.0_testacc73.8.png"
    behavior(test_results, suffix='epoch_test' suptitle, save_as)
    ...
    behavior(run_results, suffix='_from_run',
             plot_same_sample_diff_eps=True,
             which_sample=2,
             suptitle=suptitle, save_as=save_as)

    test_results = '/home/bart/Documents/data/RAM_output/RAM_results_190420_231619/run_results_190706_185402/replicate_1'
    suptitle = "learning rate = 0.01, standard devation = 0.2, test acc = 73.8%"
