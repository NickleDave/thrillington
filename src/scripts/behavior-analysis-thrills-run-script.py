...
def main():
    ...
    suptitle = "learning rate = 0.01, standard devation = 0.2, test acc = 93%"
    ...
    suptitle = "learning rate = 0.001, standard devation = 1.0, test acc = 73.8%"
    save_as = "lr0.001_std1.0_testacc73.8.png"
    ram.plot.behavior(test_results, suffix='_epoch_test', suptitle=suptitle, save_as=save_as)

    run_results = '/home/bart/Documents/data/RAM_output/RAM_results_190422_190653/run_results_190711_102716//replicate_1/examples'
    suptitle = "learning rate = 0.01, standard devation = 0.2, test acc = 93%"
